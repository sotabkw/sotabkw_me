  ...
  return (
    <div>
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="absolute right-0 w-28 mt-6 origin-top-right bg-white dark:bg-slate-800/95 divide-y divide-gray-200 dark:divide-gray-600 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
